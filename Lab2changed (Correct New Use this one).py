#I want this program to do a few things including asking the user their name, age, birthplace, and figure out how much older they are from another user.
...
age = userage
print("Congratulations for being " + str(age) + ", you are so old!")
...
#Step 10, ask how much older the first user is from another user
print("Well how many years older are you than Bobby?")
#Step 11, input other user's age on the keyboard
otheruserage = input()
#Step 12, say "Bobby is "
#Step 13, calculate the difference in age, and say " ? You ARE way too old!" back using both users' ages
print("Then he is " + str(int(userage) - int(otheruserage)) + "?" " You ARE way too old!")
